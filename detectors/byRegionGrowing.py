...
# Region Growing
FLOOD_FILL_TOLERANCE = (25, 25, 25) # loDiff, upDiff for floodFill
GRID_STEP = 10 # process every Nth pixel as a potential seed

# Contour filtering
MIN_AREA = 300

# Shape classification (from bySegmentation)
...
def run_detector(image_path, printImages=True):
    ...
    # Mask to keep track of visited pixels for floodFill
